...
tf.flags.DEFINE_string('model_path', 'model', 'saving path of model and words dict')
...
tf.flags.DEFINE_integer('seq_size', 16, 'string seq length in one input example')
tf.flags.DEFINE_integer('hidden_size', 32, 'rnn hidden cell unit size')
